...
public class StudySession {
	...
	public static void main(String[] args) {
		...
		// bean will still be created, because it eagerly instantiates all the beans
		// it just won't show up without the toString
//		funWithAuthors(ac);
//		funWithFlashcards(ac);
		
		ac.getBean("lifecycleBean"); //demonstrate lifecycle methods

		// close ApplicationContext by downcasting to AbstractApplicationContext
		// AbstractApplicatinContext is what provides us the close method
	...
	static void funWithFlashcards(ApplicationContext ac) {
		...
		f2.setQuestion("What is 9 plus 10?");
